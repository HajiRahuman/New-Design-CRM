...
class MyAppState extends State<UpdatePackAndValidity> {
  ...
  void initializeForm() {
    form = FormGroup({
      'id': FormControl<int>(
          value: widget.subscriberId, validators: [Validators.required]),
      'packid': FormControl<int>(
          value: widget.packid, validators: [Validators.required]),
  ...
  void updateValidators() {
    ...
    if ((getPackOpt?.packmode ?? 0) >= 3 && (getPackOpt?.fupmode ?? -1) == 3) {
  ...
  Future<void> UpdatePackAndValidity(value) async {
    final resp =
        await subscriberSrv.updatePacAndVal(widget.subscriberId, form!.value);
    if (resp['error'] == false) {
      ...
      child: Column(
        children: [
              ...
              children: [
                ...
                CircleAvatar(
                  ...
                  child: IconButton(
                    ...
                    icon:
                        Icon(Icons.close_rounded, color: notifier.getMainText),
                  ),
                ),
              ],
            ),
                      ...
                      suffixIcon:
                        ...
                        GestureDetector(
                          onTap: () {
                            setState(() {
                              selectedDownMbps++;
                              downLimitController.text =
                                  selectedDownMbps.toString();
                            });
                          },
                      ...
                      children: [
                        GestureDetector(
                          onTap: () {
                            setState(() {
                              selectedOnlTime++;
                              onlineLimitController.text =
                                  selectedOnlTime.toString();
                            });
                          },
                          child: Icon(Icons.arrow_drop_up,
                              color: notifier.getMainText),
          ...
          Padding(
            ...
            child: ReactiveTextField<String>(
              validationMessages: {
                'required': (error) => 'Remarks Required!',
              },
              maxLines: 3,
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  if (form!.invalid) {
                    ...
                    form!
                        .markAllAsTouched(); // Mark all fields as touched to trigger error display
                    return;
                  }
